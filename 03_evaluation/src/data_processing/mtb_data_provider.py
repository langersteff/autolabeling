...
class MtbDataProvider:
    ...
    def create_training_data(self, data, labels, window_length=50, step_size=.25, sub_sample_length=25, clear_outliers=False, calc_features=False, keep_positions=False, padding_left_right=0, feature_thresholds = None, includes_timestamp=True):
        # slice into sliding windows
        data_windowed, labels_windowed, timestamps_windowed = self.slice_into_windows(data, labels, window_length=window_length, step_size=step_size, includes_timestamp=includes_timestamp)
